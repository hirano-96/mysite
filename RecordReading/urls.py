...
urlpatterns = [
    ...
    path('delete/memory/<int:pk>/', views.DeleteMemoryView.as_view(), name='deletememory'), #詳細削除画面
    path('delete/book/<int:pk>/', views.DeleteBookView.as_view(), name='deletebook') # タイトル削除画面
]